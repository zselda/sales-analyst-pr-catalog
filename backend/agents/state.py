...
class SwarmState(TypedDict):
    ...
    # ── Local DB enrichment (bank core system, latest data) ──
    db_financial_metrics: Optional[dict]
    db_product_flags: Optional[dict]
    db_meta: Optional[dict]
    financial_ratios: Optional[dict]
    wallet_dict: Optional[dict]
    account_balances: Optional[dict]
