...
def generate_report_pdf(result: dict) -> bytes:
    ...
    story = []
    page_template = _INGPageTemplate("Financial & Sales Analysis Report")

    # ====================================================================
    # PAGE 1: Cover / Executive Summary
    # ====================================================================
    story.append(Spacer(1, 6 * mm))
    story.append(Paragraph("Financial &amp; Sales Analysis Report", styles['INGTitle']))
    ...
    story.append(Paragraph(
        ...
        "Data is based on mock trial balance and transaction records. "
    ...
    logger.info(f"[PDF] Generated report: {len(pdf_bytes)} bytes (font: {FONT_REGULAR})")
    return pdf_bytes
